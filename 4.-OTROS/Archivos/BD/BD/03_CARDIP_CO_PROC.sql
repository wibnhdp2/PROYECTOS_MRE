...
BEGIN
	BEGIN TRY
		...
		END ELSE if(@OPERACION='UPDATE') BEGIN
			UPDATE  SC_CARDIP.CD_MENSAJE_ESTADO  SET  MEES_VMENSAJE=@MEES_VMENSAJE 	WHERE MEES_SESTADOID=@MEES_SESTADOID
		END ELSE if(@OPERACION='DELETE') BEGIN
			UPDATE  SC_CARDIP.CD_MENSAJE_ESTADO  SET  MEES_CESTADO='I' 	WHERE MEES_SESTADOID=@MEES_SESTADOID
		END			
	END TRY
	BEGIN CATCH
