<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmVisorProtocolar.aspx.cs"
    Inherits="SGAC.WebApp.Reportes.FrmVisorProtocolar" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="dsReport" runat="server" Width="100%" Height="100%"
            Font-Names="Verdana" Font-Size="8pt" ShowPrintButton="false"
            WaitMessageFont-Size="14pt" ViewStateMode="Enabled"  SizeToReportContent="True" 
