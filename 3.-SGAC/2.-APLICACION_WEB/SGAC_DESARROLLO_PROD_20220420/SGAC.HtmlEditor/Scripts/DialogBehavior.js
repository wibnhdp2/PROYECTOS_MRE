...
SGAC.HtmlEditor.DialogBehavior = function(element)
{
    SGAC.HtmlEditor.DialogBehavior.initializeBase(this, [element]);
...
SGAC.HtmlEditor.DialogBehavior.prototype = 
{
    ...
    initialize: function()
    {
        SGAC.HtmlEditor.DialogBehavior.callBaseMethod(this, 'initialize');
    ...
    dispose: function()
    {
        SGAC.HtmlEditor.DialogBehavior.callBaseMethod(this, 'dispose');
    },
...
SGAC.HtmlEditor.DialogBehavior.descriptor = 
{
...
SGAC.HtmlEditor.DialogBehavior.registerClass("SGAC.HtmlEditor.DialogBehavior", Sys.UI.Behavior);
