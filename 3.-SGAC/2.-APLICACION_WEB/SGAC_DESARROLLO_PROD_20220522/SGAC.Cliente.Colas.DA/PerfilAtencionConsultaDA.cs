...
{
    public class PerfilAtencionConsultaDA
    {
        ~PerfilAtencionConsultaDA()
        {
            GC.Collect();
        }
                                   ...
                                   ref int intTotalPaginas)
        {
            ...
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("PN_CLIENTE.USP_CL_PERFILATENCION_CONSULTAR", cn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;

                        cmd.Parameters.Add(new SqlParameter("@peat_sOficinaConsularId", iOficinaconsularId));
