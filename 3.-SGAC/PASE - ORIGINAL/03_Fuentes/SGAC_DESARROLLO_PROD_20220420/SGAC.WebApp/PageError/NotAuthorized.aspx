<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotAuthorized.aspx.cs" Inherits="SGAC.WebApp.PageError.NotAuthorized" %>
            ...
            <table id="Table5" cellspacing="0" cellpadding="5" border="0">
                <tr>
                    ...
                    <td style="font-weight: bold; font-size: 18px; border-bottom: gainsboro 1px solid">
                        401.-No Autorizado. Servicio solicitado requiere de autenticación. Intentelo nuevamente.
                    </td>
                </tr>
                <tr>
                    <td align="left">
