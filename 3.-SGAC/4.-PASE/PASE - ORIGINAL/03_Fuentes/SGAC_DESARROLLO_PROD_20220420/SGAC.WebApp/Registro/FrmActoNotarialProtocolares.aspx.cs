    ...
    public partial class FrmActoNotarialProtocolares : MyBasePage
    {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (vNumeroDocumento.Length > 0 && vTipoDocumento.Length > 0)
                {
                    ...
                    for (int i = 0; i < grd_Participantes.Rows.Count; i++)
                    {
                        ...
                        if (grd_Participantes.Rows[i].Cells[0].Text == "OTORGANTE" ||
                            grd_Participantes.Rows[i].Cells[0].Text == "VENDEDOR" ||
                            grd_Participantes.Rows[i].Cells[0].Text == "DONANTE" ||
                            grd_Participantes.Rows[i].Cells[0].Text == "ANTICIPANTE")
                        {
            ...
            if (Convert.ToInt64(lPARTICIPANTE.anpa_iActoNotarialId) != 0)
            {
                    ...
                    && x.anpa_cEstado != "E").Count() == 0)
                {
                    ...
                    if (TipoActaProtocar == Convert.ToString(Convert.ToInt32(Enumerador.enmProtocolarTipo.COMPRA_VENTA)))
                        return "Debe existir al menos un tipo de participante VENDEDOR.";
                    ...
                    return "Debe existir al menos un tipo de participante OTORGANTE.";
                }
                else
                {
                    ...
                    && x.anpa_cEstado != "E").Count() == 0)
                {
                    ...
                    return "Debe existir al menos un tipo de participante APODERADO.";
                }
        ...
        public static string obtenerTextoNormativo(string cuerpo)
        {
            ...
            /*foreach (string id in words)
            {
                ...
                {
                    strArticulo += strArticulo.Length > 0 ? "," : "";
                    strArticulo += "{ \"desc\":\"" + Convert.ToString(dtArticulo.Rows[0]["arle_vDescripcionLarga"].ToString().ToUpper()) + "\"}";
        ...
        private static int ObtenerCantidadParticipantesPorTipo(Enumerador.enmNotarialProtocolarTipoParticipante enmParticipante = Enumerador.enmNotarialProtocolarTipoParticipante.NINGUNO)
        {
            int intCantidad = 0;
            ...
            {
                if (enmParticipante == Enumerador.enmNotarialProtocolarTipoParticipante.NINGUNO)
                    intCantidad++;
                else
                {
                    if ((int)Enumerador.enmNotarialProtocolarTipoParticipante.OTORGANTE == (int)enmParticipante)
                    {
                    ...
                    if ((int)Enumerador.enmNotarialProtocolarTipoParticipante.APODERADO == (int)enmParticipante)
                    {
        ...
        protected void btnGrabarVinculacion_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        if (intActoNotarialDetalleId != 0 && txtNumeroOficioAdi.Text.Trim() != string.Empty)
                        {
                            if (HF_ValidaTablaFuncionarioResponsable.Value == "S")
                            {
                                ...
                                ActualizarDatosAcnoNotarialDetalle(intActoNotarialDetalleId, txtNumeroOficioAdi.Text.Trim(), intFuncionarioResponsable);
                            }
                            else
                            {
                                ActualizarDatosAcnoNotarialDetalle(intActoNotarialDetalleId, txtNumeroOficioAdi.Text.Trim());
                            }
                        }
                    }
                    #endregion
        ...
        {            
            ...
            if (e.CommandName == "Select")
            {
                ...
                if (txtNumeroOficioAdi.Text == "")
                {
                    string yy = DateTime.Now.Year.ToString();

                    txtNumeroOficioAdi.Text = txtNroEscritura.Text + "/" + yy.Substring(2, 2);
                }
            ...
            switch (TipoFormato)
            {
                ...
                case (int)Enumerador.enmNotarialTipoFormato.PARTE:
                    ...
                    if (ActoNotarialDetalleId != 0)
                        ActualizarDatosAcnoNotarialDetalle(ActoNotarialDetalleId, NumOficio);
        ...
        private static void ActualizarDatosAcnoNotarialDetalle(Int64 intActoNotarialDetalleId, String strNumOficio, int intFuncionarioAutorizadorId=0)
        {
        ...
        //private static string VerFormatoTestimonio(Int64 AcnoNotarialId, int Correlativo)
        //{
        //    clsRespuesta oclsRespuesta = new clsRespuesta();
        //    string Mensaje = string.Empty;
        //    string oRespuesta = "";
        ...
        //        str_Testimonio = oReportesNotarialesConsultasBL.USP_RP_NOTARIAL_PROTOCOLAR_TESTIMONIO(AcnoNotarialId, intOficinaConsular, Correlativo);
        ...
        //        dt = _bl.ActonotarialObtenerParticipantes(AcnoNotarialId);

        //        _dt = _bl.ObtenerCuerpo(AcnoNotarialId);
        ...
        //        //if (dtdp.Rows[0]["vDenominacion"] != null) strDenominacion = dtdp.Rows[0]["vDenominacion"].ToString().Trim();
        ...
        //        //oDocumentoiTextSharp.NumeroEP = dtdp.Rows[0]["NumeroEscrituraPublica"].ToString();
...
//                    }
                ...
                dtOrdenadoTipParticipante.DefaultView.Sort = "id DESC";
            ...
            if (Cmb_TipoActoNotarial.SelectedIndex > 0)
            {
                ...
                for (int i = 0; i < dtOrdenadoTipParticipante.Rows.Count; i++)
                {
                    if (dtOrdenadoTipParticipante.Rows[i]["id"].ToString() == Convert.ToString((int)Enumerador.enmNotarialProtocolarTipoParticipante.OTORGANTE)
                        ...
                        || dtOrdenadoTipParticipante.Rows[i]["id"].ToString() == Convert.ToString((int)Enumerador.enmNotarialProtocolarTipoParticipante.ANTICIPANTE))
                    {
                        string TipParticipante = dtOrdenadoTipParticipante.Rows[i]["id"].ToString();
                        ddl_anpa_sTipoParticipanteId.SelectedValue = TipParticipante;
                        HF_sTipoParticipanteId.Value = TipParticipante;
                        break;
                    }
                }
                //-------------------------------------------------------
     ...
     //   }
        ...
        private bool ValidarTotalParticipantes()
        {
                ...
                && x.anpa_cEstado != "E").Count() == 0)
            {
                ...
                strScript += Mensaje.MostrarMensaje(Enumerador.enmTipoMensaje.WARNING, "ACTO PROTOCOLAR", "Debe existir al menos un tipo de participante OTORGANTE.");
                Comun.EjecutarScript(Page, strScript);
                return false;
...
//                lParticipante.Residencia.resi_cResidenciaUbigeo = Convert.ToString(hdn_acpa_pais.Value + hdn_acpa_provincia.Value + hdn_acpa_distrito.Value);
        ...
        protected void btnGrabarParticipantesNew_Click(object sender, EventArgs e)
        {
            if (ValidarTotalParticipantes() == true)
            {
                ...
                if (Cmb_TipoActoNotarial.SelectedIndex > 0)
                {
                    ...
                    //Fecha: 25/06/2021
                    //Autor: Miguel Márquez Beltrán
                    //Motivo: Consultar las fojas disponibles.
                    //-------------------------------------------
        ...
        public static string llenar_introduccion_escritura_Regular(string cuerpo)
        {
            ...
            foreach (DataRow dr in dts.Rows)
            {
                ...
                //if ((intTipoEscrituraId == (int)Enumerador.enmProtocolarTipo.PODER_GENERAL_AMPLIO_ABSOLUTO) ||
                //    (intTipoEscrituraId == (int)Enumerador.enmProtocolarTipo.PODER_ESPECIAL) ||
                //    (intTipoEscrituraId == (int)Enumerador.enmProtocolarTipo.COMPRA_VENTA))
                //{
                    ...
                    || strTipoParticipante == "ANTICIPANTE" || strTipoParticipante == "DONANTE")
                {
                    ...
                    if (contadorOtorgantes == 1)
                    {
                        ...
                        if (strGenero == (int)Enumerador.enmGenero.MASCULINO)
                        {
                            ...
                            {
                                stroPoderdanteSingularPlural = "VENDEDOR";
                            }
                            if (strTipoParticipante == "ANTICIPANTE")
                            {
                                stroPoderdanteSingularPlural = "ANTICIPANTE";
                            }
                            if (strTipoParticipante == "DONANTE")
                            {
                                stroPoderdanteSingularPlural = "DONANTE";
                            }
                    ...
                    else
                    {
                        if (strGenero == (int)Enumerador.enmGenero.MASCULINO)
                        {
                            ...
                            if (strTipoParticipante == "ANTICIPANTE")
                            {
                                stroPoderdanteSingularPlural = "ANTICIPANTES";
                            }

                            if (strTipoParticipante == "DONANTE")
                            {
                                stroPoderdanteSingularPlural = "DONANTES";
                            }
            ...
            foreach (DataRow dr in dts.Rows)
            {
                    ...
                    || strTipoParticipante == "ANTICIPANTE" || strTipoParticipante == "DONANTE")
                {
                    ...
                    else
                    {
                        ...
                        if (strTipoParticipante.Equals("DONANTE"))
                            strOtorgantePS = "DONANTES";

                        if (strTipoParticipante.Equals("ANTICIPANTE"))
                            strOtorgantePS = "ANTICIPANTES";
        ...
        public static string llenar_final_escritura_Regular(string cuerpo)
        {
            ...
            foreach (DataRow dr in dtApoderadoFiltrado.Rows)
            {
                strGenero = Convert.ToInt32(dr["iGenero"]);
                strTipoParticipante = dr["vTipoParticipanteId"].ToString();
            ...
            if (contadorInterprete > 0)
            {
                ...
                dtNorma = objNormaBL.ConsultarNorma(0, 0, strNorma, "", "", 0, 1, 1, "S", ref IntTotalCount, ref IntTotalPages);
