...
{
    public partial class ctrlToolBarButton : System.Web.UI.UserControl
    {
        #region Declare
        ...
        private bool _EnabledButtonGrabar = false;

        public bool EnabledButtonGrabar
        {
            get { return btnGrabar.Enabled; }
            set {
                _EnabledButtonGrabar = value;
                btnGrabar.Enabled = _EnabledButtonGrabar;
                UpdPopupBusqueda.Update();
            }
        }
        ...
        {
            if (btnExportarExcelHandler != null)
            {
                btnExportarExcelHandler();
            }
            else
            {
                Comun.EjecutarScript(Page, Mensaje.MostrarMensaje(Enumerador.enmTipoMensaje.WARNING, "OPCIONES", Constantes.CONST_MENSAJE_NO_IMPLEMENTACION));
        ...
        {
            if (btnExportarPDFHandler != null)
            {
                btnExportarPDFHandler();
            }
            else
            {
                Comun.EjecutarScript(Page, Mensaje.MostrarMensaje(Enumerador.enmTipoMensaje.WARNING, "OPCIONES", Constantes.CONST_MENSAJE_NO_IMPLEMENTACION));
