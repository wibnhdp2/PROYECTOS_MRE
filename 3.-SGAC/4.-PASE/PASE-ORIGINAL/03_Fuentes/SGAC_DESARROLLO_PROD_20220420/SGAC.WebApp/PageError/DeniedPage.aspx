<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeniedPage.aspx.cs" Inherits="SGAC.WebApp.PageError.DeniedPage" %>
            ...
            <table id="Table5" cellspacing="0" cellpadding="5" border="0">
                <tr>
                    ...
                    <td style="font-weight: bold; font-size: 18px; border-bottom: gainsboro 1px solid">
                        Acceso Denegado. Por favor comuníquese con Soporte Técnico
                    </td>
                </tr>
                <tr>
                    <td align="left">
