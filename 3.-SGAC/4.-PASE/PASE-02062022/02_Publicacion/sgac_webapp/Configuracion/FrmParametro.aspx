                                            ...
                                            <asp:UpdatePanel ID="updddlGrupo" runat="server" UpdateMode="Conditional">
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>                                                            
                                                            <asp:DropDownList ID="ddlGrupo" runat="server" Width="500px" AutoPostBack="True"
                                ...
                                <ContentTemplate>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlGrupoMant" runat="server" Width="500px" TabIndex="1">
                                                </asp:DropDownList>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtValorMant" runat="server" Width="500px" MaxLength="300" 
