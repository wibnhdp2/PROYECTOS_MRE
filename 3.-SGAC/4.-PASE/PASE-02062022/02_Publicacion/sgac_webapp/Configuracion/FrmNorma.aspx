...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     <script type="text/javascript">
         ...
         function asignarValorTinyMCE() {
             var descripcion = tinyMCE.editors[0].getContent();
             
             $("#<%= hdn_descripcion.ClientID %>").val(descripcion);
         }       
    </script>
    <div>
        <asp:HiddenField ID="hdn_descripcion" runat="server" />
        <%--Titulo--%>
                            ...
                            <asp:UpdatePanel ID="updConsulta" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <table>
                                       ...
                                       <tr>
                                            <td class="style2">
                                                <asp:Label ID="lblConsultaGrupo" runat="server" Text="Grupo:"></asp:Label>
                                            </td>
                                            <td>
                                            <asp:DropDownList ID="ddlConsultaGrupo" runat="server" Width="150px">
                                                </asp:DropDownList>
                                            </td>
                                            <td class="style10">
                                            ...
                                            <td>
                                             <asp:DropDownList ID="ddlConsultaEstadoNorma" runat="server" Width="150px">
                                                </asp:DropDownList>
                                            </td>
                                       </tr>
                                    </table>
                            ...
                            <asp:UpdatePanel ID="updMantenimiento" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                            <td class="style16" style="vertical-align:text-top">
                                                <asp:Label ID="lblregDescripcion" runat="server" Text="Descripción:"></asp:Label>                                              
                                            </td>
                                            <td colspan="3">
                                            
                                               <asp:TextBox ID="txtregDescripcion" runat="server" Width="600px" CssClass="mceEditor txtLetra"  
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlregEstadoNorma" runat="server" Width="150px">
                                                    </asp:DropDownList>
                                                    <label style="color:Red; font-size:medium"> &nbsp;*</label>
                                                <asp:HiddenField ID="HF_sNormaId" runat="server" />
                                            </td>
                                            <td>
                                                <asp:Label ID="lblregGrupoNorma" runat="server" Text="Grupo:"></asp:Label>
                                            </td>
                                            <td>
                                             <asp:DropDownList ID="ddlregGrupoNorma" runat="server" Width="150px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
