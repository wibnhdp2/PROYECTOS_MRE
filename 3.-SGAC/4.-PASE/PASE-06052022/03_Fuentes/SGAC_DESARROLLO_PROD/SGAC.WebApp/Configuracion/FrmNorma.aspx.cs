       ...
       #region CAMPOS
        ...
        void ctrlToolBarMantenimiento_btnGrabarHandler()
        {
            ...
            if (enmAccion == Enumerador.enmAccion.INSERTAR)
            {
                ...
                Int16 intEstadoNormaId = Convert.ToInt16(ddlregEstadoNorma.SelectedValue);

                dtNorma = objNormaBL.ConsultarNorma(0, 1, strDescripcionCortaNorma, "", "", intEstadoNormaId, 1, 1, "N", ref IntTotalCount, ref IntTotalPages);
        ...
        private void CargarListadosDesplegables()
        {
            ...
            //dtTipoNorma = Comun.ObtenerParametrosPorGrupo((DataTable)Session[Constantes.CONST_SESION_DT_PARAMETRO], "NORMA-DOCUMENTOS");
            //dtObjetoNorma = Comun.ObtenerParametrosPorGrupo((DataTable)Session[Constantes.CONST_SESION_DT_PARAMETRO], "NORMA-OBJETO");
...
//            dtEstadoNorma = Comun.ObtenerParametrosPorGrupo((DataTable)Session[Constantes.CONST_SESION_DT_ESTADO], "NORMA-ESTADO");
        ...
        private void BindGrid()
        {
            ...
            Int16 intTipoNormaId = 0;
            Int16 intEstadoNormaId = 0;
            //-----------------------------------------------------
            ...
            dtNorma = objNormaBL.ConsultarNorma(intTipoNormaId, 0, strNorma, strYYYYMMDD_Ini, strYYYYMMDD_Fin, intEstadoNormaId,
