<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InternalError.aspx.cs" Inherits="SGAC.WebApp.PageError.InternalError" %>
            ...
            <table id="Table5" cellspacing="0" cellpadding="5" border="0">
                <tr>
                    ...
                    <td style="font-weight: bold; font-size: 18px; border-bottom: gainsboro 1px solid">
                        500.-Error Interno. Se produjo un error al recuperar la informacion del servidor. Intentelo nuevamente
                    </td>
                </tr>
                <tr>
                    <td align="left">
