    ...
    public class VideoConsultaDA
    {
                                   ...
                                   ref int intTotalPaginas)
        {
            ...
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("PN_CLIENTE.USP_CL_VIDEO_CONSULTAR", cn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;

                        cmd.Parameters.Add(new SqlParameter("@vide_sOficinaConsularId", iOficinaconsularId));
