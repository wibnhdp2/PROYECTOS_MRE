...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <asp:Panel ID="tab3" runat="server">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <asp:LinkButton ID="btnContinuarIntitucion" CssClass="btn btn-primary btn-icon-split" OnClientClick="return ValidarCorreoElectronico();"
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <asp:Panel ID="tab4" runat="server">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <asp:LinkButton ID="btnContinuarFuncionCargo" CssClass="btn btn-primary btn-icon-split" OnClientClick="return ValidarCorreoElectronicoContacto();"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <asp:LinkButton ID="LinkButton9" CssClass="btn btn-outline-secondary btn-icon-split" runat="server" OnClick="btnCancelar_click"> <span class="icon text-white-50"><i class="fas fa-ban"></i></span><span class="text">Salir</span> </asp:LinkButton>
    ...
    <script type="text/javascript">
        ...
        function ValidarCorreoElectronicoContacto() {
            var regex = /[\w-\.]{2,}@([\w-]{2,}\.)*([\w-]{2,}\.)[\w-]{2,4}/;

            if (regex.test($('#<%= txtCorreoContacto.ClientID %>').val().trim())) {
                 return true;
