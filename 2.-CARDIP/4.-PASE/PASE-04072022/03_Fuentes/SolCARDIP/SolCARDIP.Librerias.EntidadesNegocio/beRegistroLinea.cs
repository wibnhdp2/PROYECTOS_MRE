...
namespace SolCARDIP.Librerias.EntidadesNegocio
{
    public class beRegistroLinea
    {
        ...
        public string ConNumeroCarne { get; set; }                                          //PARA RELACION DE DEPENDENCIA
        public DateTime FechaCreacion_inicio { get; set; }
        public DateTime FechaCreacion_fin { get; set; }
        // TIPO EMISION (OBJECT)
