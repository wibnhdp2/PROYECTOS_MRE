            ...
            <table align="center" style="width: 80%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:ImageButton ID="ibtVerFirmaAlmacenada" runat="server" ImageUrl="~/Imagenes/Iconos/openLog.png"
                                                        OnClientClick="window.open('../VerFirmaSave.aspx','_blank','width=450,height=400,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1','_blank')"
                                                        Enabled="false" ToolTip="Ver Fotografia Almacenada" BorderWidth="0" Width="15" />
                                                </td>
                                            </tr>
                                            <tr>
                ...
                <tr>
                    <td colspan="2" align="right">
                        <asp:Button runat="server" ID="btnGuardar" CssClass="ImagenBotonGuardar" Width="150px"
                            Text="Registrar Carné" OnClientClick="return validarRegistrarCarne();" OnClick="registrarCarne" />
                        <asp:Button runat="server" ID="btnGuardarEdicion" CssClass="ImagenBotonGuardar" Width="150px"
                            OnClientClick="return validarRegistrarCarne();" OnClick="guardarCambios" Text="Guardar Cambios"
                            Visible="false" />
                        <asp:Button runat="server" ID="btnCancelar" CssClass="ImagenBotonCancelar" OnClick="cancelarEdicion"
                            Width="150px" Text="Cancelar" Visible="false" />
