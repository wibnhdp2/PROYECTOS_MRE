                    ...
                    <td style="padding: 10px 0px 10px 0px">
                        <table style="text-align: center;">
                            <tr>
                                <td align="center">
                                    <h5>
                                        Ingrese el código de Solicitud a consultar:</h5>
                                </td>
                            </tr>
                            <tr>
                                            ...
                                            <asp:GridView ID="gvRegLinea" AutoGenerateColumns="false" runat="server" CssClass="table table-bordered dataTable table-hover"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ConEstadoDesc" HeaderText="Estado">
                                                        <HeaderStyle CssClass="tr-style" HorizontalAlign="Left" Width="200px" />
                                                        <ItemStyle CssClass="tr-style" HorizontalAlign="Left" Width="100px" />
                                                    </asp:BoundField>
                    ...
                    <td align="center">
                        <blockquote>
                            <h6>
                                ...
                                Tome en cuenta que solo podrá realizar esta acción hasta que se haya iniciado el
                                trámite de emisión de carnet de identidad.</h6>
                        </blockquote>
                    </td>
                </tr>
                <tr>
