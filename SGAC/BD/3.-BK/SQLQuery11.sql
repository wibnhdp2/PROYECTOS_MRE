			SELECT distinct	AP.acpa_iActuacionParticipanteId iActuacionParticipanteId, p.pers_iPersonaId iPersonaId, ISNULL(P.pers_vApellidoPaterno,'') vApellidoPaterno
		...
		left JOIN SC_MAESTRO.MA_DOCUMENTO_IDENTIDAD DI ON PEI.peid_sDocumentoTipoId = DI.doid_sTipoDocumentoIdentidadId
	WHERE RM.reCi_iActuacionDetalleId = 190599