...
Copyright (c) SGAC, Eric Williams
EMail: mail@SGAC.com, eric@SGAC.com
...
Type.registerNamespace("SGAC.HtmlEditor");

SGAC.HtmlEditor.HtmlEditor = function (element) {
    
    SGAC.HtmlEditor.HtmlEditor.initializeBase(this, [element]);
...
SGAC.HtmlEditor.HtmlEditor.prototype =
{
    ...
    OnDialogFrameLoad: function (event) {
        ...
        if (f.contentWindow) {
            ...
            if (f.contentWindow.Initialize) {
                ...
                var behavior = $create(SGAC.HtmlEditor.DialogBehavior, { "editorControl": this, "dialogDocument": dialogDocument, "contentWindow": f.contentWindow }, null, null, this.get_element());
    ...
    initialize: function () {
        SGAC.HtmlEditor.HtmlEditor.callBaseMethod(this, 'initialize');
    ...
    dispose: function () {
        ...
        SGAC.HtmlEditor.HtmlEditor.callBaseMethod(this, 'dispose');
    },
...
SGAC.HtmlEditor.HtmlEditor.descriptor = 
{
...
SGAC.HtmlEditor.HtmlEditor.registerClass("SGAC.HtmlEditor.HtmlEditor", Sys.UI.Control);
