...
{
    public class PlantillaTraduccionMantenimientoBL
    {
        public Int64 Insertar(RE_PLANTILLA_TRADUCCION pobjBe)
        {
            DA.PlantillaTraduccionMantenimientoDA objDA = new PlantillaTraduccionMantenimientoDA();
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, loption))
            {
                try
                {
                    intResultado = objDA.Insertar(pobjBe, ref s_Mensaje);
                ...
                catch (Exception ex)
                {
                    intResultado = new SGAC.Auditoria.BL.AuditoriaMantenimientoBL().Insertar_Error(new SI_AUDITORIA
                    {
                        ...
                        audi_sUsuarioCreacion = (Int16)pobjBe.pltr_sUsuarioCreacion,
        ...
        public Int64 Actualizar(RE_PLANTILLA_TRADUCCION pobjBe)
        {
            DA.PlantillaTraduccionMantenimientoDA objDA = new PlantillaTraduccionMantenimientoDA();
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, loption))
            {
                try
                {
                    intResultado = objDA.Actualizar(pobjBe, ref s_Mensaje);
                ...
                catch (Exception ex)
                {
                    intResultado = new SGAC.Auditoria.BL.AuditoriaMantenimientoBL().Insertar_Error(new SI_AUDITORIA
                    {
                        ...
                        audi_vMensaje = ex.StackTrace.ToString(),
                        audi_vHostName = Util.ObtenerHostName(),
                        audi_sUsuarioCreacion = (Int16)pobjBe.pltr_sUsuarioModificacion,
                        audi_vIPCreacion = Util.ObtenerDireccionIP()
                    });
        ...
        public Int64 Anular(RE_PLANTILLA_TRADUCCION pobjBe)
        {
            DA.PlantillaTraduccionMantenimientoDA objDA = new PlantillaTraduccionMantenimientoDA();
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, loption))
            {
                try
                {
                    intResultado = objDA.Anular(pobjBe, ref s_Mensaje);
